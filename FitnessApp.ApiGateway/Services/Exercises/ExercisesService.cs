...
public class ExercisesService(ApiClientSettings apiClientSettings, IInternalClient internalClient)
    : CollectionService<UserExercisesModel, ExerciseItemModel>(apiClientSettings, internalClient),
    IExercisesService
{
