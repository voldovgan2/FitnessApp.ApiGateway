...
public class FoodService(ApiClientSettings apiClientSettings, IInternalClient internalClient)
    : CollectionService<UserFoodsModel, FoodItemModel>(apiClientSettings, internalClient),
    IFoodService
{
